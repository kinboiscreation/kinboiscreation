...
typography:
  # — reading ramp (Space Grotesk, matches the site's body font) —
  ...
  subtitle:    { fontFamily: "Space Grotesk", cqw: 1.3,  weight: 300, lineHeight: 1.5 }
...
- **Fonts** — already set to **Cormorant Garamond** (display) / **Space Grotesk** (body); ignore any preset font name lingering in prose.
